...
#include "samd51j19a.h" // TODO: fix this
#include <string.h>
...
)
{
    ...
    if(SERCOM0_I2C_IsBusy()) {
        // TODO: handle error here
        return;
    }

    // Cast data to uint8_t* because SERCOM0_I2C_Write() expects uint8_t* instead of char*
    uint8_t* uint8_data = (uint8_t*) data;

    // Write data to the I2C device
    if (!SERCOM0_I2C_Write(device, uint8_data, dataSize)) {
        // TODO: handle error here
        return;
    }
}
